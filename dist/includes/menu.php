<div class="menu menu_closed">
    ...
    <div class="menu__main-nav">
        <div class="menu__nav menu__nav_1">
            <ul>
                <li><a class="menu__nav-link-hover" href="/">Головна</a></li>
                <li><a class="menu__nav-link-hover menu__nav-link-news" href="news.php">Новини</a></li>
                <li><a class="menu__nav-link-hover" href="#">Документація</a></li>
                <li><a class="menu__nav-link-hover" href="day-in-o2.php">Галерея</a></li>
            </ul>
        </div>
        <div class="menu__nav menu__nav_2">
            <ul>
                <li class="menu__nav-item_heading">Проект</li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="#">Про нас</a></li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="residence.php">Резиденція</a></li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="values.php">Цінності</a></li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="eco-farm.php">Еко-ферма</a></li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="advantages.php">Переваги</a></li>
            </ul>
        </div>
        <div class="menu__nav menu__nav_3">
            <ul>
                ...
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="choose-apartment.php">1-кімнатні</a></li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="choose-apartment.php">2-кімнатні</a></li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="choose-apartment.php">3-кімнатні</a></li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="choose-apartment.php">4-кімнатні</a></li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="choose-apartment.php">Підбір за параметрами</a></li>
            </ul>
        </div>
        <div class="menu__nav menu__nav_4">
            <ul>
                <li class="menu__nav-item_heading">Комерційні приміщення</li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="commercial.php">Кафе та ресторани</a></li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="commercial.php">Магазини</a></li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="commercial.php">Здоров’я та краса</a></li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="commercial.php">Освіта</a></li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="commercial.php">Сфера послуг</a></li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="commercial.php">Підбір за параметрами</a></li>
            </ul>
        </div>
        <div class="menu__nav menu__nav_5">
            <ul class="menu__nav-sub">
                <li class="menu__nav-item_heading">Хід будівництва</li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="developer.php">Забудовники </a></li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="construction.php">Будівництво</a></li>
                <li class="menu__nav-item"><a class="menu__nav-link-hover" href="#">Веб-камери</a></li>
            </ul>
        </div>
    ...
    <div class="menu__bottom-line"></div>
        <ul class="menu__bottom-items-list">
            <li class="nav__item nav__item-telephone nav__item-telephone_mobile">
                <a href="#">(093) 82-33-115</a>
            </li>
            <li class="nav__item nav__item-callback nav__item-callback_bottom-mobile nav__btn js-callback-form">
